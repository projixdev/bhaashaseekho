import { siteMeta, footer, contactPage } from "@/content";
            ...
            <tr>
              <td style="background-color:#f8fafc; padding:24px 32px; border-top:1px solid #e2e8f0;">
                <span style="font-size:13px; color:#334155; line-height:1.7;">
                  ...
                  ${contactPage.details.email} &middot; ${contactPage.details.phone}<br />
                  ${whatsappUrl ? `<a href="${whatsappUrl}" style="color:#b45309; text-decoration:none;">Chat with us on WhatsApp &rarr;</a><br />` : ""}
                  <span style="color:#94a3b8;">${footer.copyright}</span>
                </span>
              </td>
            </tr>
          </table>
