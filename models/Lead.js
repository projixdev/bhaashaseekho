...
const LeadSchema = new mongoose.Schema(
  {
    ...
    // interest is a plain string, not a schema enum: the option list lives
    // in content.js and can change without a schema migration. Validity is
    // checked at the API layer (lib/validation.js) instead.
