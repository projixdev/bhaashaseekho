  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-lg border border-border bg-background">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <Link
          href={ctaHref}
          className="mt-4 inline-block cursor-pointer rounded-md bg-accent px-6 py-3 text-center text-sm font-semibold text-white transition-opacity hover:opacity-90"
        >
          {ctaLabel}
        </Link>
      </div>
