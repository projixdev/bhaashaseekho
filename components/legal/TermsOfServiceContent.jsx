...
export default function TermsOfServiceContent() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="font-heading text-3xl font-bold text-foreground">{termsOfService.heading}</h1>
      <p className="mt-2 text-sm text-secondary">{termsOfService.lastUpdatedLabel}</p>
